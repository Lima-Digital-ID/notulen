...
class Ref_gaji extends CI_Controller
{
    ...
    {
        $data['title']='Referensi Gaji';
        $this->template->load('template','hrms/master_ref_gaji/tbl_ref_gaji_list', $data);
    } 
    ...
    public function json() {
        ...
        echo $this->Tbl_ref_gaji_model->json();
    }
