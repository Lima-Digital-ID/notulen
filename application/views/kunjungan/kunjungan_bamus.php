...
<script>
    $(document).ready(function(){
       $('#data_list').DataTable( {
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?=base_url('kunjungan/kunjungan_json4')?>",
                "type": "POST"
            },
            "aaSorting": [[ 1, "desc" ]],
            "columns": [
