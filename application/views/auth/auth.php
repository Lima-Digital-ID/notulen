...
#copyright{
    ...
    <div class="main-wrapper">
        ...
        <!-- Login box.scss -->
        <!-- ============================================================== -->
        <div class="auth-wrapper d-flex flex-column no-block justify-content-center align-items-center" style="background:url(<?=base_url('assets/')?>theme/assets/images/big/auth-bg.jpg) no-repeat center center;">
            <div class="auth-box mb-3">
                <div id="loginform">
                    <div class="logo">
                         <span class="db"><img height="270px" src="<?=base_url('assets/')?>theme/assets/images/logo3.png" alt="logo" /></span>
                        <span class="db"><img src="<?=base_url('assets/')?>theme/assets/images/logo-icon2.png" alt="logo" /></span>
                    </div>
                    <!-- Form -->
                    <div class="row">
                        <div class="col-12">
                            <form class="form-horizontal m-t-20" id="loginform" action="<?=base_url()?>auth/checklogin" method="post">
                                ...
                                <div hidden class="form-group m-b-0 m-t-10">
