...
<body>
    <div class="main-wrapper">
        ...
        <!-- Login box.scss -->
        <!-- ============================================================== -->
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center" style="background:url(<?=base_url('assets/')?>theme/assets/images/big/auth-bg.jpg) no-repeat center center;">
            <div class="auth-box">
                <div>
                    <div class="logo">
                        <span class="db"><img src="<?=base_url('assets/')?>theme/assets/images/logo_coolio.png" alt="logo" width="120px"/></span>
                        <h5 class="font-medium m-b-20">Sign Up</h5>
                    </div>
                    <!-- Form -->
                    <div class="row">
                        <div class="col-12">
                            <form class="form-horizontal m-t-20" action="<?=base_url('/auth/saveRegister')?>" method="post">
                                ...
                                <div class="form-group row">
                                    <div class="col-12 ">
                                        <input class="form-control form-control-lg" type="" name="telp" id="telp" required=" " placeholder="No Telp" onchange="cekTelp(this.value)">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-12 ">
        ...
        $.ajax({
            ...
            success : function(response){
                ...
                if (response['data']['exists'] == 1) {
                    $('#telp').val('');
                    alert('Nomor telepon yang anda input sudah ada, coba nomor yang lain');
                }
            } 
        })
    }
