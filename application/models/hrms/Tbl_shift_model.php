...
class Tbl_shift_model extends CI_Model
{
    ...
    // datatables
    function json() {
        $this->datatables->select('id_shift, nama_shift, jam_datang, jam_pulang');
        $this->datatables->from('tbl_shift');
        $this->datatables->add_column('action', anchor(site_url('hrms/shift/update/$1'),'<i class="fa fa-edit" aria-hidden="true"></i>', array('class' => 'btn btn-success btn-sm'))." 
                ".anchor(site_url('hrms/shift/delete/$1'),'<i class="fa fa-trash" aria-hidden="true"></i>','class="btn btn-danger btn-sm" onclick="javasciprt: return confirm(\'Are You Sure ?\')"'), 'id_shift');
